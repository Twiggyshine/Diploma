    ...
    <footer className="footer">
        ...
        <div className="wrapper">
          <div className="wrapper_footer__column">
            <ul className="wrapper_footer column__title">
              <li>RESOURCES</li>
              <li>GIFT CARDS</li>
              <li>FIND A STORE</li>

    ...
    <footer className="footer">
      <div className="wrapper">
        <div className="wrapper_footer">
          <div className="wrapper_footer__column">
            <ul className="wrapper_footer__column__title">
              <li>RESOURCES</li>
              <li>GIFT CARDS</li>
              <li>FIND A STORE</li>
            ...
            <ul className="wrapper_footer column__company">
              <li>COMPANY</li>
              <li>About Nike</li>
              <li>Careers</li>
              <li>News</li>
